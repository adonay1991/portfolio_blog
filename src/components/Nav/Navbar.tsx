...
export const Navbar: Component = () => {
	return (
		<nav class='nav'>
			...
			<a class='social' href="https://www.linkedin.com/in/adonay-rodriguez-0243a0175/">
			...
			<a class='social' href="https://github.com/adonay1991">
			...
			<a class='social' href="https://dev.to/">
